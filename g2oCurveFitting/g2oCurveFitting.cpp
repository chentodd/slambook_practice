...
// The vertex model, y = exp(ax^2 + bx + c), vertex: abc
class CurveFittingVertex : public g2o::BaseVertex<3, Eigen::Vector3d>
{
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW

    // Override setToOriginImpl()
...
// The error model, e = y - exp(ax^2 + bx + c)
...
int main(int argc, char **argv)
{
    ...
    // Start solver
    std::cout << "start opimization" << std::endl;
