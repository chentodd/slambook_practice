...
BALProblem::BALProblem(const std::string &filename, bool use_quaternions)
{
    ...
    // For camera we have 6 parameters for its pose, 1 parameter for its focal
    // length and 2 parameters for distortion factor.
    // For points we have 3 paramters(X, Y, Z)
